...
public class Graph {
	...
	public ListenableGraph<String, Edge> buildGraph() {
		System.out.println("Build graph to txt file [" + getFileName() + "]...");
		ListenableDirectedWeightedGraph<String, Edge> graph = new ListenableDirectedWeightedGraph<String, Edge>(
				Edge.class);
	...
	public void readInFromTxTDoc(String path) {
		this.path = path;
		System.out.println("Reading in txt doc from [" + getFileName() + "]...");
